...
class NetworksKnownForMovies extends StatelessWidget {
  const NetworksKnownForMovies({super.key});
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: TrendingItemTitle(),
              ),
              _TrendingCirclePercentage(),
              Padding(
                padding: const EdgeInsets.symmetric(
                  vertical: 15,
                  horizontal: 60,
                ),
                child: TrendingSummary(),
              ),
              Padding(padding: const EdgeInsets.all(10), child: Overview()),
              Padding(
                padding: const EdgeInsets.all(10),
                child: TrendingMediaNames(),
              ),
              SizedBox(height: 10),
              TrendingCast(),
            ],
...
class TrendingItemProfile extends StatelessWidget {
  const TrendingItemProfile({super.key});
...
class TrendingItemTitle extends StatelessWidget {
  const TrendingItemTitle({super.key});
...
class _TrendingCirclePercentage extends StatelessWidget {
  const _TrendingCirclePercentage();
...
class TrendingSummary extends StatelessWidget {
  const TrendingSummary({super.key});
...
class TrendingMediaNames extends StatelessWidget {
  const TrendingMediaNames({super.key});
...
class TrendingCast extends StatelessWidget {
  const TrendingCast({super.key});
    ...
    return ColoredBox(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 270, child: Scrollbar(child: TrendingCastList())),
        ],
      ),
    );
  }
...
class TrendingCastList extends StatelessWidget {
  const TrendingCastList({super.key});
